    ...
    <section className="py-24 text-white" id="about">
      ...
      <div className="flex flex-col items-center gap-4 mb-16">
        ...
        <p
          ...
          data-aos="zoom-in-up"
        >
          Building modern web applications with clean design and scalable solutions.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        <div className="flex flex-col gap-6 flex-1" data-aos="fade-left">
          ...
          <div className="mt-2">
            <Link
              href="#"
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-medium rounded-full transition duration-300 hover:scale-105 shadow-lg shadow-indigo-500/30"
            >
              <FaDownload size={14} />
              Download CV
            </Link>
