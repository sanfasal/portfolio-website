  ...
  return (
    <section className="min-h-[calc(100vh-80px)] flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 py-10 md:py-16 text-white">
      ...
      <div className="flex flex-col gap-5 md:gap-6 w-full md:w-1/2 items-center md:items-start">
        {/* Badge */}
        <div
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-indigo-500/40 bg-indigo-500/10 text-indigo-400 text-sm font-medium"
          data-aos="fade-down"
          data-aos-delay="0"
        >
        ...
        >
          <a
            href="#contact"
            className="px-6 py-2.5 bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-medium rounded-full transition duration-300 hover:scale-105 shadow-lg shadow-indigo-500/30"
          >
            Hire Me
          </a>
          <button className="px-6 py-2.5 text-white text-sm rounded-full border border-white/20 hover:border-indigo-500 hover:text-indigo-400 transition duration-300 hover:scale-105">
            Download CV
          </button>
        </div>
