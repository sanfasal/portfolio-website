import { skillsData } from "@/static-data/data";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillsData.map((skill, index) => (
            ...
            >
              ...
              <div
                className="
                  absolute -top-10 -right-10 w-40 h-40 bg-indigo-500/10
                  rounded-full blur-3xl opacity-0 group-hover:opacity-100 duration-500 "
              ></div>

              {/* Percent */}
              <h1
                className="
                  text-6xl font-black text-white/10 absolute top-6 right-6"
              >
                {skill.percent}
              </h1>
              ...
              <div className="relative z-10">
                ...
                <div className="w-full h-[6px] bg-white/10 rounded-full overflow-hidden">
                  <div
                    className="h-[6px] rounded-full bg-gradient-to-r from-indigo-500 to-indigo-400 transition-all duration-1000 "
                    style={{
                      width: `${skill.percent}%`,
                    }}
                  ></div>
